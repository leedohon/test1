...
public class SeatFragmentView extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        return inflater.inflate(R.layout.seat_item_view, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ImageView topImg = (ImageView) view.findViewById(R.id.topImg_view);
        LinearLayout top = (LinearLayout) view.findViewById(R.id.top_view);
        ImageView pic = (ImageView) view.findViewById(R.id.team_pic_view);
        TextView teamName = (TextView) view.findViewById(R.id.team_name_view);
        TextView teamDuty = (TextView) view.findViewById(R.id.team_duty_view);
        TextView seatText = (TextView) view.findViewById(R.id.seat_text_view);
        TextView seatNothing = (TextView) view.findViewById(R.id.nothing_has);
    ...
    try {
        ...
        try{
            ...
            top.setVisibility(View.GONE);
            seatText.setVisibility(View.GONE);
            seatNothing.setVisibility(View.VISIBLE);
        }
    }
